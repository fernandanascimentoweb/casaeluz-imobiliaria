...
const Projects = () => {
  ...
  return (
    ...
    // motion e apara animacao antes da div 
    <motion.div 
    ...
    className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>
            Projetos <span className='underline underline-offset-4 decoration-1 under font-light'> Concluidos </span>
        </h1>
        <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'> Espaço de Criação, Construindo Legados - Explore Nosso Portfólio </p>
